...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <p class="details">
             Registrate para poder contactar con nosotros y podamos avisarte de nuevos productos, cambios y promociones.</p>
            
              	<div class="contact_form">
              	  <form id="form2" name="form2" method="post" action="registro_usuario.php">
              	    ...
              	    <input name="registrarse" type="submit" class="register" id="registrarse" value="Registrarse" />
              	    <p>&nbsp;</p>
           	      </form>
              	</div>  
