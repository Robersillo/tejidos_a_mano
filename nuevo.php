...
mysql_select_db("tejidos_a_mano");
mysql_query("insert into productos (id,nombre,colores,disponibilidad,cantidad,tipo,precio) values ('$a','$b','$c','$d','$e','$f','$g')");
?>
            <center>
              <h3>Producto NUEVO a&ntilde;adido con Exito</h3>
            </center></p>
       	   </div>
       	   <div class="clear"></div>
        </div>
